            ...
            <div id="poetry-container" class="content-container">
                ...
                <div id="poetry-empty-state" class="empty-state">
                    <div class="empty-state-content">
                        ...
                        <div class="empty-state-text">点击 "学习诗词" 开始学习</div>
                    </div>
                </div>
                <div id="poetry-loading" class="loading-indicator">
                    <div class="loading-spinner"></div>
                    <div class="loading-text">加载中...</div>
                </div>
                <div id="poetry-display" class="poetry-display">
                    <div class="poetry-content">
                        <div class="poetry-title">诗词标题</div>
                        <div class="poetry-text">
                            诗词内容
                        </div>
                        <div class="poetry-author">作者</div>
                    </div>
                    <div class="poetry-controls">
                        <button id="prev-poetry-button">上一首</button>
                        <button id="next-poetry-button">下一首</button>
                    </div>
                </div>
            </div>
        `;
        
        document.body.appendChild(newPoetryPanel);
    }
    
    // Add event listeners for poetry tab
    if (poetryButton) {
        poetryButton.addEventListener('click', function() {
            switchPanel('poetry-panel');
            handlePoetryDisplayState();
        });
    }
    
    // Handle poetry display state
    handlePoetryDisplayState();
});

// Update handleTabSwitch function to handle poetry display state
function handleTabSwitch(containerType) {
    // ... existing tab switching code ...

    // If switching to poetry tab, initialize poetry display state
    if (containerType === 'poetry') {
        // Delay slightly to ensure DOM elements are created
        setTimeout(() => {
...
// Update the handlePoetryDisplayState function
function handlePoetryDisplayState() {
    ...
    if (!poetryDisplay || !emptyState || !learnButton) {
        return;
    }
