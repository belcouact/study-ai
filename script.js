    ...
    function initializeEmptyDropdowns() {
        ...
        allDropdowns.forEach(dropdown => {
            ...
            if (!emptyOption) {
                ...
                emptyOption.value = '';
                emptyOption.textContent = ''; // Blank text
                
                // Insert at the beginning
                dropdown.insertBefore(emptyOption, dropdown.firstChild);
            } else {
                // Update existing empty option to have blank text
...
window.populateGradeOptions = function(school) {
    ...
    if (gradeDropdown) {
        gradeDropdown.innerHTML = '<option value=""></option>';
    }
    
    if (sidebarGradeDropdown) {
        sidebarGradeDropdown.innerHTML = '<option value=""></option>';
    }
...
window.populateSubjectOptions = function(school) {
    ...
    // Clear existing options in both dropdowns
    if (subjectDropdown) {
        subjectDropdown.innerHTML = '<option value=""></option>';
    }
    
    if (sidebarSubjectDropdown) {
        sidebarSubjectDropdown.innerHTML = '<option value=""></option>';
    }
...
function populateGradeOptions(school) {
    ...
    // Clear existing options in both dropdowns
    if (gradeDropdown) {
        gradeDropdown.innerHTML = '<option value="">请选择</option>';
    }
    
    if (sidebarGradeDropdown) {
        sidebarGradeDropdown.innerHTML = '<option value="">请选择</option>';
    }
...
function populateSubjectOptions(school) {
    ...
    // Clear existing options in both dropdowns
    if (subjectDropdown) {
        subjectDropdown.innerHTML = '<option value="">请选择</option>';
    }
    
    if (sidebarSubjectDropdown) {
        sidebarSubjectDropdown.innerHTML = '<option value="">请选择</option>';
    }
