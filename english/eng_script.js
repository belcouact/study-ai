document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch('600 english sentences.txt')
        ...
        .catch(error => {
            ...
            cardContainer.innerHTML = `<div class="loading">Error loading sentences: ${error.message}<br>Please make sure "600 english sentences.txt" is in the same folder as this HTML file.</div>`;
        });
